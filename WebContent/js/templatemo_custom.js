...
jQuery(document).ready(function($){
    ...
    */
    ...
    $(".content-gallery").click(function(){
    	...
    	$(this).parent("div.gallery-item").find("img").animate(
    	{
    		opacity: 0
    	},function(){
    		$(this).parent("div.gallery-item").find(".content-gallery").animate(
		    	{
		    		top:"-418px"
		    	},
		    	1000,
    		...
    		$(this).parent("div.gallery-item").find(".content-gallery").addClass("opened");
    	});
    	/*
    	$(this).parent("div.gallery-item>img").animate(
    	{
    		top:"-418px"
    	},
    	1000,
