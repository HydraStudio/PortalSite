...
<body>
		...
		<tbody id="TableData" class="dataContainer">
			<s:iterator value="recordList">
				<tr class="TableDetail1 template">
					...
					<td>${imageUrl}</td>
					<td>
						<s:a action="modifyInputContact?id=%{id}">修改</s:a>
						<s:a action="deleteContact?id=%{id}" id="delete" onclick="confirmDel()">删除</s:a>
					</td>
				</tr>
			</s:iterator>
	</table>
	<div id="TableTail">
        <div id="TableTail_inside">
            <a href="addInputContact.action"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></a>
        </div>
    </div>
	<div align="center">
		<%@ include file="/WEB-INF/public/pageView.jsp" %>
		<s:form action="listContact"></s:form>
	</div>
