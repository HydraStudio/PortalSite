...
<body>
			...
			<s:iterator value="recordList">
				<tr class="TableDetail1 template">
					...
					<td>
						...
						<s:a action="deleteAchievement?id=%{id}" id="delete" onclick="confirmDel()">删除</s:a>
					</td>
				</tr>
			</s:iterator>
	</table>
	<div id="TableTail">
        <div id="TableTail_inside">
            <a href="addInputAchievement.action"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></a>
        </div>
    </div>
	<div align="center">
		<%@ include file="/WEB-INF/public/pageView.jsp" %>
		<s:form action="listAchievement"></s:form>
	</div>
