...
<div class="ItemBlockBorder">
	<s:form action="%{id==null ? 'add':'modify'}Achievement" theme="simple" enctype="multipart/form-data" method="post" id="inputAction">
		<s:hidden name="id" id="id"></s:hidden>
		<s:hidden name="changeFlag" id="changeFlag"></s:hidden>
		<table cellpadding="0" cellspacing="0" class="mainForm">
			<tr>
				<td>图片：</td>
				<td><s:file name="upload" id="file"></s:file><span>(建议图片像素大小为980*600)</span></td>
			</tr>
			<tr>
				<td>图片名字：</td>
